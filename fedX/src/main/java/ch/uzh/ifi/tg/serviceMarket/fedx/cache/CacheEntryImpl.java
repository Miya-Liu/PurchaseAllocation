...
import ch.uzh.ifi.tg.serviceMarket.fedx.exception.EntryUpdateException;
...
public class CacheEntryImpl implements CacheEntry{
	...
	public Cache.StatementSourceAssurance canProvideStatements(Endpoint endpoint) {
		...
		return entry == null ? Cache.StatementSourceAssurance.POSSIBLY_HAS_STATEMENTS :
					( entry.doesProvideStatements() ? Cache.StatementSourceAssurance.HAS_REMOTE_STATEMENTS : Cache.StatementSourceAssurance.NONE );
	}
