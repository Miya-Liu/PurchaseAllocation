...
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.SparqlFederationEvalStrategy;
...
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.EvaluationStrategyFactory;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.FederationEvalStrategy;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.SailFederationEvalStrategy;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.SparqlFederationEvalStrategy;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.concurrent.ControlledWorkerScheduler;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.concurrent.Scheduler;
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.union.ControlledWorkerUnion;
...
import ch.uzh.ifi.tg.serviceMarket.fedx.monitoring.Monitoring;
import ch.uzh.ifi.tg.serviceMarket.fedx.monitoring.MonitoringFactory;
import ch.uzh.ifi.tg.serviceMarket.fedx.monitoring.MonitoringUtil;
import ch.uzh.ifi.tg.serviceMarket.fedx.sail.FedXSailRepository;
import ch.uzh.ifi.tg.serviceMarket.fedx.statistics.Statistics;
import ch.uzh.ifi.tg.serviceMarket.fedx.structures.Endpoint;
import ch.uzh.ifi.tg.serviceMarket.fedx.structures.Endpoint.EndpointClassification;
...
import ch.uzh.ifi.tg.serviceMarket.fedx.util.Version;
...
public class FederationManager {
	 ...
	 */
	public static SailRepository initialize(List<Endpoint> members, Cache cache, Statistics statistics, ServiceDescription serviceDescription) {
		if (instance!=null)
		...
		instance = new FederationManager(federation, cache, statistics, ex, repo, serviceDescription);
	...
	private FederationManager(FedX federation, Cache cache, Statistics statistics, Executor executor, Repository repo, ServiceDescription serviceDescription) {
