 ...
 */
public class RandomPriceManager implements PriceManager {
    ...
    public RandomPriceManager(float priceCoefficient, int seed) {
        random = new Random(seed);
        this.priceCoefficient = priceCoefficient;
        priceMap = new HashMap<>();
    }

    public RandomPriceManager(float priceCoefficient) {
        random = new Random();
        this.priceCoefficient = priceCoefficient;
        priceMap = new HashMap<>();
    }
    ...
    public float getPrice(String productId) {
        if (!priceMap.containsKey(productId)) {
            priceMap.put(productId, priceCoefficient * random.nextFloat());
        }
