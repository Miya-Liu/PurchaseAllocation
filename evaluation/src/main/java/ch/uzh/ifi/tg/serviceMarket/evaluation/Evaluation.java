...
public class Evaluation {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for (Request request : requests) {
            ...
            for (DataAndServiceQuery dataAndServiceQuery : request.getQueries()) {
                ...
                runMarket(writer, dataAndServiceQuery, hosts, noGraphQuery, iterations, serviceModel);
    ...
    public static void runMarket(PrintWriter writer, DataAndServiceQuery dataAndServiceQuery, List<String> hosts, boolean noGraphQuery, int iterations, Model serviceModel) throws Exception {
        ...
        for (int i = 0; i < iterations; ++i) {
            startTime = System.currentTimeMillis();
            if (!noGraphQuery) {
                allocation = runAllocation(result, numberOfTriplePatterns, dataAndServiceQuery.getValuePerRow(), dataAndServiceQuery.getBudget());
            }
    ...
    public static List<DataBundle> runAllocation(List<BindingSet> bindings, int numberOfTriples, float valuePerRow, float budget) throws IloException {
