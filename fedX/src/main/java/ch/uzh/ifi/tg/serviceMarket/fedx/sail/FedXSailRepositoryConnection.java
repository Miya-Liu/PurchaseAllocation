...
package ch.uzh.ifi.tg.serviceMarket.fedx.sail;
...
public class FedXSailRepositoryConnection extends SailRepositoryConnection
{
	...
	private void insertOriginalQueryString(SailQuery query, String queryString, QueryType qt) {
		query.setBinding(BINDING_ORIGINAL_QUERY, ValueFactoryImpl.getInstance()
				.createLiteral(queryString));
		query.setBinding(BINDING_ORIGINAL_QUERY_TYPE, ValueFactoryImpl.getInstance()
