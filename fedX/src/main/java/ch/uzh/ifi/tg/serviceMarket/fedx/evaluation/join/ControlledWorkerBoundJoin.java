...
import ch.uzh.ifi.tg.serviceMarket.fedx.algebra.BoundJoinTupleExpr;
	...
	protected void handleBindings() throws Exception {
		...
		if (!closed && leftIter.hasNext()) {
			...
			if (expr instanceof StatementTupleExpr) {
				...
				// Commenting out the statements below makes sure that product is included in the solution
