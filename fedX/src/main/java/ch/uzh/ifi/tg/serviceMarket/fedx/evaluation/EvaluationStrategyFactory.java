...
import ch.uzh.ifi.tg.serviceMarket.fedx.Config;
import ch.uzh.ifi.tg.serviceMarket.fedx.FederationManager.FederationType;
...
public class EvaluationStrategyFactory {
	 ...
	 * the query. The type depends on the {@link FederationManager.FederationType} as well as on the
