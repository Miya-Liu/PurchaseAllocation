...
import ch.uzh.ifi.tg.serviceMarket.fedx.evaluation.iterator.StatementConversionIteration;
...
public class SailTripleSource extends TripleSourceBase implements TripleSource{
	...
	public CloseableIteration<BindingSet, QueryEvaluationException> getStatements(
		...
		RepositoryResult<Statement> repoResult = conn.getStatements((Resource)subjValue, (URI)predValue, objValue, true, new Resource[0]);
	...
	@Override
	public CloseableIteration<Statement, QueryEvaluationException> getStatements(RepositoryConnection conn, Resource subj, URI pred, Value obj, Resource... contexts) throws RepositoryException,
	...
	public boolean hasStatements(StatementPattern stmt,
		...
		return conn.hasStatement((Resource)subjValue, (URI)predValue, objValue, true, new Resource[0]);
	}
